...
Before training i hadthe scans in my train set undergo augmentations ot improve genralisations, tunrs out rotations and flips didn't really do anythin to help at all and only slowed the process where as slight affines, nois, gamme, and normalisation helped the process. keep in mind I normalised not only the train set but all the scans.
