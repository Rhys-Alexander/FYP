...
\item \textbf{Cross-modality transfer:} Knowledge from one imaging modality is transferred to another~\cite{yang2020mri}.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.5\textwidth]{figures/cropping.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.5\textwidth]{figures/normalisation_accuracy.png}
