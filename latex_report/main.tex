...
% after correcting for group leakage saw test accuracies of 79.14\%, 67.63\%, and xxx\% respectively.
...
% TODO put the accurate values in the table
...
\begin{itemize}
    \item Despite theoretical computational advantages of mixed and factorized convolutions, R3D-18 demonstrated substantially faster training times (1 hour/epoch) compared to MC3-18 (4 hours/epoch) and R(2+1)D (5 hours/epoch).
